<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/Default.aspx.cs" Inherits="WebForm1" %>
        ...
        <div align="center">
            ...
            <div style="border: 1px solid; border-radius: 6px; background-color: white; width: 80%">
                <ol class="progtrckr" data-progtrckr-steps="6">
                    <li class="progtrckr-todo"><a href="#" style="text-decoration: none; color: black">Personal Details</a></li>
                    <li class="progtrckr-todo">Academic Details</li>
                    <li class="progtrckr-todo">Postal Details</li>
                        ...
                        <div id="loginbox">
                                ...
                                <fieldset>
                                    ...
                                    <dl>
                                        <dt>
                                            ...
                                            <img id="myUploadedImg" alt="" style="width: 180px;" />

                                            <input type="button" name="uploadx" value="Upload" id="picload" />
                                        </dt>
                            ...
                            <div>
                                ...
                                <fieldset>
                                    ...
                                    <dl>
                                        <dt>
 <input type="file" id="f_UploadImagex" /><br />
                                            <img id="myUploadedImgx" alt="" style="width: 180px;" />

                                            <input type="button" name="uploadx" value="Upload" id="picloadx" /></dt>
                    ...
                    <div id="colA">
                        ...
                        &nbsp;<div id="open" style="display: block">
                            ...
                            <fieldset>
                                ...
                                <dl>
                                    <dt>
                                        <label>First Name:<span>*</span></label><input name="FirstName" maxlength="50" id="FirstName" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Middle Name:<span></span></label><input name="MiddleName" maxlength="50" id="MiddleName1" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Last Name:<span></span></label><input name="LastName" maxlength="50" id="LastName2" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                    ...
                                    <dl>
                                    <dt>
                                        <label>Mobile Number:<span>*</span></label><input name="mobilenum" maxlength="10" id="mobilenumt" onkeypress="return numbersOnly(event);"   type="text"  /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Date of Birth:<span>*</span></label><input name="dob" type="text" id="datepicker" /><img class="ui-datepicker-trigger" src="Images/Calendar.png" alt="..." title="..." /></dt>
                                ...
                                <dl>
                                    <dt>
                                        ...
                                        <select name="ddlBloodgroup" id="ddlbloodgroupp">
                                ...
                                <dl>
                                    <dt>
                                        ...
                                        <select name="ddlGendert" id="ddlGendert">
                                ...
                                <dl>
                                    <dt>
                                        ...
                                        <select name="ddlBloodgroupt" id="ddlbloodgrouppt">
                                ...
                                <dl>
                                    <dt>
                                        <label>Mother Tongue:<span></span></label><input name="mothertoungetxtName" maxlength="50" id="mothertounge" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Nationality:</label><input type="radio" id="sex" value="Indian" name="ty"  checked="checked" />Indian<input type="radio" id="sex1" value="NRI" name="ty" />NRI<input type="radio" id="sex2" value="Foreigner" name="ty" />Foreigner<input type="radio" id="ot" value="Other" name="ty" />Other</dt>
                                </dl>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Area:</label><input type="radio" id="urban" value="Urban" name="tkk"  checked="checked" />Urban<input type="radio" id="rural" value="Rural" name="tkk" />Rural</dt>
                                </dl>
                                ...
                                <dl>
                                    <dt>
                                        <label>Email ID:<span>*</span></label><input name="txtEmail" maxlength="34" id="txtEmail"  type="text" /></dt>
                                    <dd><span id="tiptxtEmail" class="validator"></span>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>
                                        <label>Confirm Email ID:<span>*</span></label><input name="txtEmail2" maxlength="34" id="txtEmail2"  type="text" /></dt>
                                  ...
                                  <dl>
                                    <dt>
                                       <label>Father's Name:<span>*</span></label><input name="FatherName" maxlength="16" id="FatherName"  type="text" />
                                    </dt>
                                ...
                                <dl>
                                    <dt>
                                       <label>Mother's Name:<span>*</span></label><input name="MotherName" maxlength="16" id="MotherName"  type="text" />
                                    </dt>
                                ...
                                <dl>
                                    <dt>
                                        ...
                                        <select name="ddlpocc" id="ddlpoccu">
                                ...
                                <dl>
                                    <dt>
                                        <label>Parent's E-Mail ID<span>*</span></label><input name="Txtpemail" maxlength="36" id="TxtPemail" class="validator"   type="text" />
                                    </dt>
                                    <dd>
                                ...
                                <dl>
                                    <dt>
                                        <label>Adhar Number:<span></span></label><input name="txtAdhar" maxlength="16" id="txtConfirmPassword"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Bank Account Number:<span>*</span></label><input name="txtAc" maxlength="16" id="txtAc" type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>IFSC CODE:<span>*</span></label><input name="txtifsc" maxlength="16" id="txtifsc"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Bank Name:<span>*</span></label><input name="bankname" maxlength="16" id="bankname"  type="text" /></dt>
                            ...
                            <div class="buttonwrap">
                                <input name="btnRegistered" value="SAVE & PROCEED" id="btnRegistered" class="button" type="button" />
