<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/admissionfeepayment.aspx.cs" Inherits="admissionfeepayment" %>
<!DOCTYPE>
<html>
<head runat="server">
    <style type="text/css">
...
<body>
 ...
 <div>    
    ...
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="Admission fee" disabled="disabled" /></span>
    </div>  
