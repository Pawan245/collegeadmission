<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/AcademicDetails.aspx.cs" Inherits="AcademicDetails" %>
...
<ul>
        ...
        <div align="center">
            ...
            <div style="border: 1px solid; border-radius: 6px; background-color: white; width: 80%">
                <ol class="progtrckr" data-progtrckr-steps="6">
                    ...
                    <li class="progtrckr-todo"><a href="#" style="text-decoration: none; color: black">Academic Details</a></li>
                        ...
                        <div id="open" style="display: block;">
                            ...
                            <fieldset>
                               ...
                               <div class="buttonwrap">
                                <input name="btnRegistered" value="ADD QUALIFICATIONS" id="addqualification" class="button" type="button" onclick="bh()" />
    ...
    <thead class=" btn-primary btn-lg">
        ...
        <th style="">Delete</th>
                            ...
                            <div class="buttonwrap">
                                <input name="btnRegistered" value="SAVE & PROCEED" id="btnRegisteredwe" class="button" type="button" runat="server" />

                                <input type="button" id="prt" runat="server" value=""  hidden="hidden" />
  ...
  <div class="modal-content">
    ...
    <p style="text-align:center;font-size:x-large;color:blue;">Add Qualification</p>

   <form id="fm" style="background-color:#9df655;">
 ...
 <legend>Add Qualification:</legend>
                                ...
                                <dl>
                                    <dt>
                                        <label>Obtain Marks/Percentage/Grade Points:<span>*</span></label><input name="dob" type="text" id="datepicker" maxlength="5"  onkeypress="return numbersOnlyx(event);"  /></dt>
                                ...
                                <dl>
                                    ...
                                    <dt>
                                        <label>Out of Marks/Percentage/Grade Points:<span>*</span></label><input name="mothertoungetxtName" maxlength="5" id="mothertounge" onkeyup="this.value=this.value.toUpperCase()"  type="text"  onkeypress="return numbersOnlyx(event);" /></dt>
    ...
    <option value='December'>December</option>
                                ...
                                <dl>
                                    <dt>
                                        <label>Passing Year:<span>*</span></label><input name="txtEmail" maxlength="4" id="txtEmail"   onkeypress="return numbersOnly(event);" type="text" /></dt>
      ...
      <dl>
                                ...
                                <dl>
                                    <dt>
                                        <label>Seat No:<span>*</span></label><input name="txtEmail2" maxlength="14" id="txtEmail2"  type="text"  onkeypress="return numbersOnly(event);" /></dt>
...
<input type="button" id="sdk"  name="Refreshttk" value="Submit"/>
 ...
 <script>
    ...
    <script>
         ...
         function numbersOnlyx(event) {
        var key = (event.hasOwnProperty('charCode')) ? event.charCode : event.which;
        // Return "true" for all numbers and the delete (a.k.a., backspace) key.
        return ((key >= 48 && key <= 57) || key == 8 || key == 32 || key == 9|| key == 190) ? true : false;
         }
      </script>
