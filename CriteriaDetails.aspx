<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/CriteriaDetails.aspx.cs" Inherits="CriteriaDetails" %>
                    ...
                    <div id="colA">
                        ...
                        &nbsp;<div id="open" style="display: block">
                            ...
                            <fieldset>
                                ...
                                <dl>
                                    <dt>
                                        <label>Board/University Name:<span>*</span></label>                                
                                              <select name="boardorunivercity" id="boardorunivercity">
                                ...
                                <dl>
                                    <dt>
                                        <label>Total  Marks:<span></span></label>
                                         ...
                                         <select name="LastName" id="LastName2" runat="server" >
                                ...
                                <dl>
                                    <dt>
                                        <label>Obtain Marks :<span>*</span></label><input name="dob" type="text" id="datepickert" maxlength="5"   runat="server"  /></dt>
                                ...
                                <dl>
                                    ...
                                    <dt>
                                        <label>Percentage:<span>*</span></label><input name="mothertoungetxtName" maxlength="5" id="mothertounge"   type="text"   readonly="true" /></dt>
...
<input name="ddlGender" maxlength="18" id="ddlGender"    type="text" />
      ...
      <dl>
                                ...
                                <dl>
                                    <dt>
                                        <label>Mark sheet No:<span></span></label><input name="txtEmail2" maxlength="14" id="txtEmail2"  type="text"  onkeypress="return numbersOnly(event);" /></dt>
 ...
 <script>
        ...
        return ((key >= 48 && key <= 57) || key == 8 || key == 32 || key == 9) ? true : false;
                            ...
                            <div class="buttonwrap">
                                <input name="btnRegistered" value="SAVE & PROCEED" id="btnRegisteredcret" class="button" type="button" />
