<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/OtherDetails.aspx.cs" Inherits="OtherDetails" %>
        ...
        <div align="center">
            ...
            <div style="border: 1px solid; border-radius: 6px; background-color: white; width: 80%">
                <ol class="progtrckr" data-progtrckr-steps="6">
                    <li class="progtrckr-done"><a href="Personal" style="text-decoration: none; color:green">Personal Details</a></li>
                    <li class="progtrckr-done"><a href="Criteria" style="text-decoration: none; color: green">Criteria Details</a></li>
                    <li class="progtrckr-done"><a href="Postal" style="text-decoration: none; color: green">Postal Details</a></li>
                    <li class="progtrckr-done"><a href="Academic" style="text-decoration: none; color: green">Academic Details</a></li>
                    <li class="progtrckr-todo">Other Details</li>
                </ol>
                <div id="container">
                     ...
                     <div id="colCx">
                            <dl>
                                    <dt>
                                        ...
                                        <input name="win" maxlength="66" id="winp" type="text" /></dt>
...
<fieldset>
                          ...
                          <dl>
                                    <dt>
                                        <label>NCC/NSS:<span></span></label><input name="FirstName" maxlength="50" id="FirstName" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Social Work:<span></span></label><input name="MiddleName" maxlength="50" id="MiddleName1" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Computing Skills:<span></span></label><input name="LastName" maxlength="50" id="LastName2" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                          ...
                          <dl>
                                    <dt>
                                        <label>Sports/Games:<span></span></label><input name="FirstName1" maxlength="50" id="FirstName1" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Elocution/Writing:<span></span></label><input name="MiddleName1" maxlength="50" id="MiddleName12" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Others:<span></span></label><input name="LastName1" maxlength="50" id="LastName22" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                          ...
                          <fieldset>
                           ...
                           <dl>
                                    <dt>
                                        <label>Periodical/Journals you prefer to read regularly:<span></span></label><input name="FirstName2" maxlength="50" id="FirstName10" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>How do you keep updated with current affairs:<span></span></label><input name="MiddleName2" maxlength="50" id="MiddleName120" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Reason for selecting of this particular course:<span></span></label><input name="LastName2" maxlength="50" id="LastName220" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                         ...
                         <dl>
                                    <dt>
                                        <label>How this choice will help in building carrer?<span></span></label><input name="LastName3" maxlength="50" id="LastName2200" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                            ...
                            <fieldset>
                                ...
                                <dl>
                                    <dt>
                                        ...
                                        <select name="ddlGender" id="ddlGenderm">
                                ...
                                <input type="file" id="FileUpload1" style="display: none" /><br />
    ...
    <thead class=" btn-primary btn-lg">
        ...
        <th style="">Delete</th>
                    ...
                    <div class="clear"></div>
                            ...
                            <div class="buttonwrap">
                                                                <input type="button" id="prtmm" runat="server" value="" name="tui"  hidden="hidden" />

                                <input name="btnRegistered" value="SAVE & PROCEED" id="btnRegisteredzx" class="button" type="button" />
