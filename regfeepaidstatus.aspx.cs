...
public partial class regfeepaidstatus : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (Request.Form["status"] == "success")
            {
                ...
                else
                {
                    ...
                    id = HttpContext.Current.Session["txnm"].ToString();



                    studentid = HttpContext.Current.Session["stid"].ToString();
                   



                    String fgt = fg.updatepaymenttable(studentid,id,order_id);


                    if (fgt == "success")
                    {
                        fg.updateforregfeepaid(studentid, order_id);
                    }
            ...
            else
            {
                ...
                try
                {
                    ...
                    String hj = HttpContext.Current.Session["txnm"].ToString();
                    ...
                    if (!String.IsNullOrEmpty(hj))
                    {
                        ...
                        studentid = HttpContext.Current.Session["stid"].ToString();
                        fg.updatepaymenttablek(studentid,  id, order_id);
