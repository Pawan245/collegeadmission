<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/App_Backend/PostalDetails.aspx.cs" Inherits="PostalDetails" %>
        ...
        <div align="center">
            ...
            <div style="border: 1px solid; border-radius: 6px; background-color: white; width: 80%">
                <ol class="progtrckr" data-progtrckr-steps="6">
                    ...
                    <li class="progtrckr-done"><a href="Criteria" style="text-decoration: none; color: green">Academic Details</a></li>
                    <li class="progtrckr-todo"><a href="#" style="text-decoration: none; color: black">Postal Details</a></li>
                    ...
                    <div id="colA">
                        ...
                        &nbsp;<div id="open" style="display: block">
                            ...
                            <fieldset>
                                ...
                                <dl>
                                    <dt>
                                        <label>Current Address:<span>*</span></label><textarea name="dob"  id="datepicker" ></textarea></dt>
...
<option value="West Bengal">West Bengal</option>
                                ...
                                <dl>
                                    <dt>
                                        <label>City:<span>*</span></label><input name="city" maxlength="50" id="ciyn" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Pin Code/Zip Code:<span>*</span></label><input name="pin" maxlength="6" id="pinn" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Landline No:<span></span></label><input name="land" maxlength="10" id="land" onkeypress="return numbersOnly(event);" type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Mobile Number:<span>*</span></label><input name="mobile" maxlength="10" id="mobilenum" onkeypress="return numbersOnly(event);"   type="text" /></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Current Address:<span>*</span></label><textarea name="pdob"  id="pdatepicker" ></textarea></dt>
                                ...
                                <dl>
                                    <dt>
                                        <label>Country:<span>*</span></label>
                                        <select name="pddlGender" id="pddlGender">
                                             <option value="df" selected="selected">------------Select Country------------</option>
                                          <option value="India">India</option>
                                            <option value="Other">Other</option>
                                ...
                                <dl>
                                    <dt>
                                        <label>State:<span>*</span></label>
                                        <select name="pddlBloodgroup" id="pddlbloodgroupp">
                                             <option value="df">------------Select State------------</option>
<option value="Andaman and Nicobar Islands">Andaman and Nicobar Islands</option>
<option value="Andhra Pradesh">Andhra Pradesh</option>
<option value="Arunachal Pradesh">Arunachal Pradesh</option>
...
<option value="West Bengal">West Bengal</option>
                                ...
                                <dl>
                                    <dt>
                                        <label>City:<span>*</span></label><input name="pcity" maxlength="50" id="pciyn" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Pin Code/Zip Code:<span>*</span></label><input name="ppin" maxlength="6" id="ppinn" onkeyup="this.value=this.value.toUpperCase()"  type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Landline No:<span></span></label><input name="pland" maxlength="10" id="pland" onkeypress="return numbersOnly(event);"  type="text" /></dt>
                                 ...
                                 <dl>
                                    <dt>
                                        <label>Mobile Number:<span>*</span></label><input name="pmobile" maxlength="10" id="pmobilenum"  onkeypress="return numbersOnly(event);"  type="text" /></dt>
                            ...
                            <div class="buttonwrap">
                                <input name="btnRegistered" value="SAVE & PROCEED" id="btnRegisterednt" class="button" type="button" />
 ...
 <script>
    ...
    <script>
        ...
        {
 ghhh=studentrecord.mobilenumber;
        }
        Response.Write( ghhh);%>');
