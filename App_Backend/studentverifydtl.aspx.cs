...
public partial class studentverifydtl : System.Web.UI.Page
{
    ...
    {
        String regid = Request.QueryString["sid"].ToString();

       
        Class1 fg = new Class1();

        String hj = fg.getdetailsbyid("dfff", fg.Decryptx(regid.Replace(" ", "+")));
        ...
        String ert = "Regid:" + fg.Decryptx(regid.Replace(" ", "+")) + ",Gender:"+genderx+",Caste:"+castex+",Blood Group:"+bloodgroupx+", Hons.:"+honsx+"";
    ...
    public static string savex(String datan)
    {
        ...
        if (datan != String.Empty)
        {
            ...
            return df.verifydtl(HttpContext.Current.Session["dry"].ToString(), datan);
