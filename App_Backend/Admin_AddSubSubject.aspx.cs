...
public partial class Admin_AddSubSubject : System.Web.UI.Page
    {
        ...
        public static string delprogram(String data1, String data2)
        {
            ...
            if (data1 != String.Empty)
            {
                ...
                return (df.deleteprogramrn(data1, data2));
    ...
    public static string delprogram2(String data1, String data2)
    {
        ...
        if (data1 != String.Empty)
        {
            ...
            return (df.deleteprogramrt(data1, data2));
